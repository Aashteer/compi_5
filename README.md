...
В отчете нужно приложить:

1. Скриншот работы лексера на корректном и ошибочном вводе.
2. Скриншот работы рекурсивного спуска на корректном и ошибочном вводе.
3. Скриншот таблицы тетрад для корректной цепочки.
4. Скриншот построения ПОЛИЗ и вычисленного значения для целочисленного выражения.

## Запуск

```bash
python lab6_expression_analyzer.py
```
